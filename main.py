...
deathSound = pygame.mixer.Sound('sound/death.mp3')
reloadSound = pygame.mixer.Sound('sound/reload.mp3')
...
class player(object):
    ...
    def hit(self):
        ...
        text = font1.render('You died', 1, (255, 0, 0))
...
class enemy(object):
    ...
    walkLeft = [pygame.image.load('enemy/L1E.png'), pygame.image.load('enemy/L2E.png'),
                pygame.image.load('enemy/L3E.png'), pygame.image.load('enemy/L4E.png'),
                pygame.image.load('enemy/L5E.png'), pygame.image.load('enemy/L6E.png'),
